  ...
  private templates: MessageTemplate[] = [
    {
      ...
      content: 'Bonjour {patient_name}, nous vous rappelons votre rendez-vous du {date_rdv} à {heure_rdv} avec le Dr {nom_medecin}. Cordialement, l\'équipe de {nom_clinique}.',
      maxLength: 160,
      status: 'active',
      active: true,
    ...
    },
    {
      ...
      content: 'Bonjour {patient_name}, votre rendez-vous du {date_rdv} à {heure_rdv} avec le Dr {nom_medecin} est confirmé. Merci de votre confiance. {nom_clinique}',
      maxLength: 160,
      status: 'active',
      active: true,
      createdAt: '2024-01-01T00:00:00Z',
    ...
    },
    {
      ...
      content: 'Bonjour {patient_name}, nous vous informons que votre rendez-vous du {date_rdv} à {heure_rdv} a été annulé. Nous vous recontacterons pour reprogrammer. {nom_clinique}',
      maxLength: 160,
      status: 'active',
      active: true,
      createdAt: '2024-01-01T00:00:00Z',
    ...
    },
    {
      ...
      content: 'Bonjour {patient_name}, nous vous informons que {message_content}. Cordialement, l\'équipe de {nom_clinique}.',
      maxLength: 160,
      status: 'active',
      active: true,
      createdAt: '2024-01-01T00:00:00Z',
    ...
    },
    {
      ...
      content: 'URGENT - Bonjour {patient_name}, nous vous contactons concernant votre rendez-vous. Merci de nous rappeler au plus vite. {nom_clinique}',
      maxLength: 160,
      status: 'inactive',
      active: false,
      createdAt: '2024-01-01T00:00:00Z',
